{{-- Template para generar PDF de confirmación de intercambio --}}
{{-- Se usa para crear documentos descargables cuando se completa un intercambio --}}
...
<head>
    ...
    <style>
        ...
        {{-- Barra superior con título e información del intercambio --}}
        .header {
        ...
        {{-- Tabla con los detalles de la reserva intercambiada --}}
        .main-table {
            width: 90%;
            margin: 30px auto;
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1>¡Intercambio confirmado!</h1>
            <p>Tu intercambio ha sido procesado correctamente</p>
        </div>

        {{-- ======= TABLA DE DETALLES DE LA RESERVA ======= --}}
        {{-- Información completa de la nueva reserva obtenida por intercambio --}}
