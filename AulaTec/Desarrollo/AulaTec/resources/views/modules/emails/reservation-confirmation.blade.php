{{-- Vista del email de confirmación de nueva reserva --}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style>
        ...
        /* HEADER CON GRADIENTE Y MENSAJE DE CONFIRMACIÓN */
        .header {
            text-align: center;
            padding: 24px;
        ...
        /* SECCIÓN DEL CÓDIGO QR (NO UTILIZADA EN ESTA VISTA) */
        .qr-section {
            text-align: center;
            margin: 24px;
        }
...
<body>
    ...
    <div class="container">
        ...
        {{-- ======= HEADER CON MENSAJE DE CONFIRMACIÓN ======= --}}
        <div class="header">
            ...
            <p style="margin:0;opacity:0.9">Tu reserva ha sido procesada correctamente</p>
        </div>
